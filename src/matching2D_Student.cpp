    ...
    if (selectorType.compare("SEL_NN") == 0){ // nearest neighbor (best match)
      ...
      double t = (double)cv::getTickCount();
        ...
        cout << "(KNN) # keypoints removed = " << knn_matches.size() - matches.size() << endl;
      	cout << "(KNN) # keypoints matched = " << matches.size() << endl;
    }
}
...
// Detect keypoints in image using the Harris detector. Refer to Harris Corner Detection Exercise source code.
...
// Detect keypoints in image using FAST, BRISK, ORB, AKAZE, or SIFT detector. Refer to Popular Keypoint Detectors Exercise source code.
